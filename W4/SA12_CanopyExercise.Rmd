...
trees <- st_read("../../cds-spatial/Week02/data/trees.shp")

# Read in the neighborhood shapefile
neighborhoods <- st_read("../../cds-spatial/Week02/data//neighborhoods.shp")
...
ggplot(tree_counts_renamed, aes(x = boroname, y = tree_cnt)) + geom_col() + theme_minimal() + ggtitle("Total counts of trees by hood") + xlab("Hood") + ylab("Tree count")
...
neighborhoods_crs <- sf::st_transform(neighborhoods_counts, crs = raster::crs(canopy, asText = TRUE))
